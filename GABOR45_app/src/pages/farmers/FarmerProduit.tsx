import {IonList, IonCard, IonCardContent, IonContent, IonCardHeader, IonCardTitle, IonTitle} from '@ionic/react';
import { Farmer } from '../../models/Farmer';
import { useHistory } from 'react-router';
import React, { useState, useEffect } from 'react';
import { getUsersWithFarmersByCategory, getCategories } from '../../services/farmerServiceCategory';
        ...
        <IonContent>
            {categories.map((category:any) => (
                <div key={category}>
                    ...
                    <IonList>
                        {farmers.filter((farmer) => farmer.type_produit_principal === category).map(farmer => ( 
