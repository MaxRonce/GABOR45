  ...
  if (!n || !BUILD.hotModuleReplacement) {
    ...
    switch (a) {
      case "pwa-action-sheet":
        return import("./pwa-action-sheet.entry-K6S2CNCO.js").then(s, consoleError);
      case "pwa-camera-modal":
        return import("./pwa-camera-modal.entry-QF4OP6BA.js").then(s, consoleError);
      case "pwa-toast":
        return import("./pwa-toast.entry-DCJUAFTO.js").then(s, consoleError);
      case "pwa-camera-modal-instance":
        return import("./pwa-camera-modal-instance.entry-N2RGBWM2.js").then(s, consoleError);
      case "pwa-camera":
        return import("./pwa-camera.entry-O4MIT6VZ.js").then(s, consoleError);
    }
  }
...
//# sourceMappingURL=chunk-MHQRHQ7X.js.map
